...
const projects = [
    ...
    },
    {
        ...
        "content":"PaceMon is a cutting-edge computer vision web app designed for real-time vehicle speed and mobility monitoring. Leveraging advanced object detection and segmentation algorithms, PaceMon accurately detects vehicle numbers, enforces penalties for violations, and ensures efficient traffic management. This innovative solution was recognized among the Top 15 Submissions in the prestigious Smart City Hackathon organized by Honeywell and the Bengaluru Traffic Department, showcasing its potential to transform urban mobility systems.",
...
for(let i=0;i<projects.length;i++){
    ...
    document.getElementById("web-container").appendChild(clone);
}
